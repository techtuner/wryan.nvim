...
local DEFAULT_COLORS = {
  ...
  bright_red = "#a36a83",
  bright_green = "#53a6a6",
  bright_yellow = "#FFEE79",
  bright_blue = "#395573",
  bright_magenta = "#c55e8c",
  bright_cyan = "#5AD1AA",
  bright_white = "#f2f2f2",
  menu = "#21222C",
  visual = "#00005d",
...
local colors = vim.tbl_deep_extend('force', DEFAULT_COLORS, vim.g.wryan_colors or {})
...
M.apply = function()
    ...
    local isItalic = vim.g.wryan_italic_comment == true
	...
	if(vim.g.wryan_transparent_bg == true) then
	...
	if(vim.g.wryan_show_end_of_buffer == true) then
